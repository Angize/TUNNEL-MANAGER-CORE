...
func TestEveryAntiLeakRuleGoesInAtTheTopOfItsChain(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"raw/udp", "OUTPUT", func() { _, _ = addRawDrop(testDst, "udp", "core42", 0, 0, true, false, false) }},
		{"raw/tcp", "OUTPUT", func() { _, _ = addRawDrop(testDst, "tcp", "core42", 0, 0, true, false, false) }},
		{"raw/tcp server", "OUTPUT", func() { _, _ = addRawDrop(testDst, "tcp", "core42", 0, 0, false, false, true) }},
		{"raw/icmp", "OUTPUT", func() { _, _ = addRawDrop(testDst, "icmp", "core42", 0, 0, false, true, false) }},
